...
#[derive(Debug)]
pub struct GrpcServicesProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GrpcServicesProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GrpcServices processing");
    
    let mut processor = GrpcServicesProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GrpcServicesProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GrpcServicesProcessor::new(false);
